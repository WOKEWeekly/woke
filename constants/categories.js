module.exports = {
  categories: [
    { label: 'Academia', short: 'academia' },
    { label: 'Christian', short: 'christian', },
    { label: 'Ethnicity', short: 'ethnicity', },
    { label: 'Family & Relationships', short: 'family', },
    { label: 'Gender', short: 'gender', },
    { label: 'Mental Health', short: 'mental', },
