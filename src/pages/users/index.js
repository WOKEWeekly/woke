...
class _User extends PureComponent {
  ...
  changeClearance = () => {
    ...
    request({
      ...
      onSuccess: () => {
        alert.success(
          `You've successfully changed ${firstname} ${lastname}'s clearance.`
        );
        this.closeEdit();
  ...
  render() {
    ...
    const header = <h2 className={css.text}>Change Clearance</h2>;
    const body = (
      ...
      <React.Fragment>
        <Fader
          ...
          <Default>
            ...
            <span>
              <button className={css.invisible_button} onClick={this.openEdit}>
                <Icon name={'edit'} />
              </button>
            </span>
            <span>
        ...
        <Modal show={editVisible} header={header} body={body} footer={footer} />
